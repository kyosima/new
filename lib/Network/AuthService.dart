...
Future<void> signInWithOTP(BuildContext context, String phoneNumber) async {
  return await _auth.verifyPhoneNumber(
    ...
    codeSent: (String verificationId, int? resendToken) async {
      finish(context);
      await showInDialog(context, child: OTPDialogBox(verificationId: verificationId, isCodeSent: true, phoneNumber: phoneNumber), shape: dialogShape(), barrierDismissible: false);
    },
