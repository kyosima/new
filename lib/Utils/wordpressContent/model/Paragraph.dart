...
class Paragraph {
  ...
  const Paragraph(
      {this.type, this.rawContent, this.textSpans, this.imageUri, this.jwMediaId, this.youtubeVideoId, this.soundcloudTrackId, this.soudcloudEmbedCode, this.hearthisAtTrackId, this.fontFamily, this.textAlign, this.pdf});

  factory Paragraph.heading(String? rawContent, List<TextSpan> textSpans, String? fontFamily, TextAlign textAlign) {
    return Paragraph(
        type: "heading",
  ...
  factory Paragraph.text(String? rawContent, List<TextSpan> textSpans, String? fontFamily, TextAlign textAlign) {
    return Paragraph(
        type: "text",
        rawContent: rawContent,
        textSpans: textSpans,
  ...
  factory Paragraph.quote(String rawContent, List<TextSpan> textSpans, String fontFamily, TextAlign textAlign) {
    return Paragraph(
        type: "quote",
        rawContent: rawContent,
        textSpans: textSpans,
  ...
  factory Paragraph.image(String? imageUri, String caption, List<TextSpan> captionSpans) {
    return Paragraph(
      type: "image",
      rawContent: caption,
  ...
  factory Paragraph.issuu(SimpleArticle pdfArticle) {
    return Paragraph(type: "issuu", rawContent: "", textSpans: [], imageUri: "", youtubeVideoId: "", soundcloudTrackId: "", soudcloudEmbedCode: "", hearthisAtTrackId: "", pdf: pdfArticle);
  }

  factory Paragraph.fromJson(Map<String, dynamic> json) {
    if (json.isEmpty) return new Paragraph();
    ...
    try {
      if (type == "heading") {
        textSpans = parseHeadingHTML(rawContent, textAlign: textAlign, fontFamily: fontFamily).textSpans;
      } else if (type == "text") {
        textSpans = parseParagraphHTML(rawContent, textAlign: textAlign, fontFamily: fontFamily).textSpans;
      } else if (type == "image") {
