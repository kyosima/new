class ViewCommentModel {
  ...
  ViewCommentModel({this.author, this.authorName, this.authorUrl, this.content, this.date, this.dateGmt, this.id, this.link, this.parent, this.post, this.status, this.type});
